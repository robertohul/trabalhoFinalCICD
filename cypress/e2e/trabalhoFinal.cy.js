...
describe("Automation Exercise", () => {
  ...
  it("Test Case 2: Login User with correct email and password", () => {
    menu.irParaLoginCadastro();
    login.preencherLogin(email, senha).verificarUsuarioLogado(nomeUsuario);
  });

  it("Test Case 3: Login User with incorrect email and password", () => {
    menu.irParaLoginCadastro();
    login
      .preencherLogin(faker.internet.email(), faker.internet.password())
      .mostrarSenhaErrada();
  });
  ...
  it("Test Case 5: Register User with existing email", () => {
    menu.irParaLoginCadastro();
    cadastro.iniciarCadastro(email).verificarMensagemDeEmailExistente();
  });
  ...
  it("Test Case 8: Verify All Products and product detail page", () => {
    menu.irParaProdutos();
    produto.verificarTodosProdutos().verificarDetalhesDoPrimeiroProduto();
  });
  ...
  it("Test Case 15: Place Order: Register before Checkout", () => {
    ...
    carrinho.fazerCheckOut().fazerPagamento();
    login.deletarConta();
  });
});
